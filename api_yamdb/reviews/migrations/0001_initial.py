# Generated by Django 3.2 on 2023-03-21 11:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(db_index=True, validators=[reviews.validators.validate_year], verbose_name='Дата выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(validators=[django.core.validators.MaxValueValidator(10, message='Оценка должна быть от 1 до 10'), django.core.validators.MinValueValidator(1, message='Оценка должна быть от 1 до 10')], verbose_name='Оценка произведения')),
